...
def get_dataset(
  ...
  dataset_configs['dataset_dir'] = "/mnt/c/Users/Tianqi/tensorflow_datasets/"
...
def log_eval_summary(
  ...
  plt_val_steps.append(len(plt_val_steps))
  plt_val_accuracy.append(eval_metrics_summary["accuracy"])
  plt_val_total_loss.append(eval_metrics_summary["loss_xentropy"])

  plt.plot(plt_val_steps, plt_val_accuracy, color="r")
  plt.title("Validation_Accuracy")
  plt.savefig("Validation_Accuracy.png")
  plt.clf()

  plt.plot(plt_val_steps, plt_val_total_loss, color="r")
  plt.title("Validation_Loss_XEntropy")
  plt.savefig("Validation_Loss_XEntropy.png")
  plt.clf()
...
plt_steps = []
plt_train_accuracy = []
plt_train_total_loss = []
plt_train_total_loss_xe = []
...
def log_train_summary(
  ...
  # print(train_metrics_summary)
  # {'accuracy': 0.015624999999877931, 'loss_xentropy': 4.705693244897319, 'ncr_loss': 0.0, 'softmax_cross_entropy': 4.705693240228388, 'total_loss': 4.705693240228388}
  plt_steps.append(len(plt_steps))
  plt_train_accuracy.append(train_metrics_summary["accuracy"])
  plt_train_total_loss.append(train_metrics_summary["total_loss"])
  plt_train_total_loss_xe.append(train_metrics_summary["loss_xentropy"])

  plt.plot(plt_steps, plt_train_accuracy, color="r")
  plt.title("Train_Accuracy")
  plt.savefig("Train_Accuracy.png")
  plt.clf()

  plt.plot(plt_steps, plt_train_total_loss, color="r")
  plt.title("Train_Loss")
  plt.savefig("Train_Loss.png")
  plt.clf()

  plt.plot(plt_steps, plt_train_total_loss_xe, color="r")
  plt.title("Train_Loss_XEntropy")
  plt.savefig("Train_Loss_XEntropy.png")
  plt.clf()
